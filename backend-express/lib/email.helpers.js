...
const applicationConfirm = pug.compileFile(process.cwd() + '/email-templates/application-confirm.pug');
const applicationSubmit = pug.compileFile(process.cwd() + '/email-templates/application-submit.pug');
const weeklyStatsUpdate = pug.compileFile(process.cwd() + '/email-templates/weekly-stats.pug');
const finalMonthlyStats = pug.compileFile(process.cwd() + '/email-templates/monthly-stats.pug');
const paymentRequest = pug.compileFile(process.cwd() + '/email-templates/payout-request.pug');
